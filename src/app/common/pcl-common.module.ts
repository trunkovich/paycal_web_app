...
@NgModule({
    ...
    exports: [
      PclButtonComponent, PclHeaderComponent, NavigationComponent, LoaderComponent, PhonePipe, MultilineErrorMsgComponent, SafeUrlPipe
    ],
    declarations: [
      PclButtonComponent, PclHeaderComponent, NavigationComponent, PhonePipe, LoaderComponent, MultilineErrorMsgComponent, SafeUrlPipe
    ],
    providers: [],
})
